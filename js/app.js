...
const STORAGE_KEY = 'sagc_productos_v4';
...
const DEFAULT_DATA = {
  ...
  products: [
    {codigo:'S0001',nombre:'VESTIDO LARGO CASUAL',marca:'Karitos Urban',categoria:'👗Vestido',precio:30,descuento:5,imagen:'https://drive.google.com/thumbnail?id=1Trp27HKz7XihpiSxL7Gw3YNIfhMocVCh&sz=w500',video:'',descripcion:'',destacado:'',estado:'Activo',palabrasClave:'vestido largo casual',variantes:[],mayoreo:[]},
    {codigo:'S0002',nombre:'FALDA DEPORTIVA',marca:'Generico',categoria:'Ropa',precio:50,descuento:0,imagen:'https://drive.google.com/thumbnail?id=10G8PUzFNvPbBlrcbD5pKZuuAkb57h5hX&sz=w500',video:'',descripcion:'Falda short deportiva con bolsillo oculto.',destacado:'',estado:'Activo',palabrasClave:'falda deportiva short bolsillo',variantes:[],mayoreo:[{desde:6,precio:40},{desde:12,precio:30},{desde:24,precio:20}]},
    {codigo:'S0005',nombre:'JEAN CLASICO',marca:'Monina',categoria:'Ropa',precio:60,descuento:15,imagen:'https://drive.google.com/thumbnail?id=1SyagsIQI4Ye4qkjfzCsc-CqVpRIE8ohl&sz=w500',video:'',descripcion:'Jean clásico.',destacado:'Nuevo Ingreso',estado:'Activo',palabrasClave:'jean clasico pantalon',variantes:[
      {id:cryptoId(),opcion1:'Celeste claro',opcion2:'28',imagen:'https://drive.google.com/thumbnail?id=1SyagsIQI4Ye4qkjfzCsc-CqVpRIE8ohl&sz=w500',stock:0,activo:true},
      {id:cryptoId(),opcion1:'Celeste claro',opcion2:'30',imagen:'',stock:20,activo:true},
      {id:cryptoId(),opcion1:'Beige Claro',opcion2:'28',imagen:'https://drive.google.com/thumbnail?id=1Fn51jNVjlJYfNDbPUjvWA-eyN4zQHUUT&sz=w500',stock:20,activo:true},
      {id:cryptoId(),opcion1:'Negro',opcion2:'28',imagen:'https://drive.google.com/thumbnail?id=15C5KZm2uQoCkF-AAJQ92fHjfmu_QUB0X&sz=w500',stock:20,activo:true},
      {id:cryptoId(),opcion1:'Rojo',opcion2:'28',imagen:'https://drive.google.com/thumbnail?id=1QT7kiqDYZeDcKY6nhuMvEB4yCT-uBxwO&sz=w500',stock:20,activo:true}
    ],mayoreo:[]}
  ]
};
let db = loadDb();
...
async function syncFromSheets(){ const btn=document.getElementById('syncSheetsBtn'); if(btn){btn.disabled=true;btn.textContent='Sincronizando…';} try{const data=await apiRequest('bootstrap'); db={products:data.products||[],colors:data.colors||[]}; saveDb(); renderProductsShell(); alert('Datos reales cargados desde Google Sheets.');}catch(err){alert(err.message);}finally{if(btn){btn.disabled=false;btn.textContent='↻ Sincronizar';}} }
  ...
  content.innerHTML=`<section class="module-page products-module">
    <div class="page-actions compact-head">
      ...
      <div class="action-row">
        ...
        <button class="btn btn-secondary compact-btn" id="syncSheetsBtn">↻ Sincronizar</button><button class="btn btn-primary" id="newProductBtn">+ Nuevo producto</button>
      </div>
    </div>
...
function bindProductShell(){
  ...
  document.getElementById('syncSheetsBtn').onclick=syncFromSheets;
