...
const DEFAULT_DATA = {
  colors: [
    {id:'c-rojo',nombre:'Rojo',hex:'#ef4444'},
    {id:'c-azul',nombre:'Azul',hex:'#2563eb'},
    {id:'c-verde',nombre:'Verde',hex:'#16a34a'},
    {id:'c-negro',nombre:'Negro',hex:'#111827'},
    {id:'c-blanco',nombre:'Blanco',hex:'#ffffff'},
    {id:'c-amarillo',nombre:'Amarillo',hex:'#facc15'},
    {id:'c-rosado',nombre:'Rosado',hex:'#ec4899'},
    {id:'c-morado',nombre:'Morado',hex:'#9333ea'}
  ],
  products: [
...
function bindConfiguration(){
  ...
  document.getElementById('saveColorBtn').onclick=()=>{
    ...
    db.colors.push({id:cryptoId(),nombre,hex}); saveDb(); renderConfiguration();
  };
}
