...
let draftVariants = [];
let draftWholesale = [];
const state = {search:'',category:'',status:'',variant:'',wholesale:'',page:1,pageSize:10};
...
function renderProductsShell(){
  ...
  content.innerHTML=`<section class="module-page">
    <div class="page-actions"><div><p class="eyebrow">Módulo empresarial</p><h2 class="module-heading">Productos, variantes y mayoreo</h2><p class="module-description">Buscador inteligente, edición completa y guardado local funcional.</p></div><div class="action-row"><button class="btn btn-secondary" id="exportBtn">Exportar JSON</button><label class="btn btn-secondary file-btn">Importar JSON<input id="importFile" type="file" accept="application/json"></label><button class="btn btn-primary" id="newProductBtn">+ Nuevo producto</button></div></div>
